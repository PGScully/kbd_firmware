...
#define RGB_MATRIX_MAXIMUM_BRIGHTNESS 150 // limits maximum brightness of LEDs to 150 out of 255. Higher may cause
...
/* Enable the animations you want/need.  You may need to enable only a small
 * number of these because       * they take up a lot of space.  Enable and
 * confirm that you can still successfully compile your firmware. */
